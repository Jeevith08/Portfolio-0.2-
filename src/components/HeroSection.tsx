      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8 w-full">
        ...
        <div className="flex-1 text-center md:text-left order-2 md:order-1 mt-4 md:mt-0 md:pl-32">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center md:justify-start mb-8 md:mb-16">
            ...
            <a href="JEEVITH resume.pdf.pdf" download className={`px-3 py-2 border-2 rounded-full font-medium transition-all duration-300 flex items-center justify-center gap-2 text-xs ${darkMode ? 'border-white text-white hover:bg-white hover:text-black' : 'border-black text-black hover:bg-black hover:text-white'}`}> <Download className="w-4 h-4" /> CV </a>
          </div>
          {/* Stats */}
